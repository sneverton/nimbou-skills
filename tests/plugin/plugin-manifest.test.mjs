...
test('shared specification skills document the domain-centered layout', () => {
  ...
  assert.match(think, /use `mapping-domain-states` to create or update `docs\/domain\/<domain>\/domain\.md`/i)
  assert.match(think, /use `generating-gherkin-specs` to create or update `docs\/domain\/<domain>\/\*\.feature`/i)
  ...
  assert.match(think, /do not do the `domain\.md` or `\*\.feature` work inline inside `nuxt-think`/i)
  ...
  assert.match(think, /`docs\/domain\/<domain>\/domain\.md` approved\./i)
  assert.match(think, /`docs\/domain\/<domain>\/\*\.feature` approved\./i)
})
